...
By moduł BMS poprawnie kontrolował stan ogniw, należy go podłączyć w następujący sposób dla pakietu 2S \ref{fig:BMS-2S-schematic} oraz alternatywny pakietu 2S2P \ref{fig:BMS-2S2P-schematic}. Wyjścia "0V", "4,2V" i "8,4V" z modułu BMS zostały przylutowane do koszyczków ogniw 18650, a wyjścia "+" i "-" wychodzą na zasilanie nakładki L293D Motor Driver Board.
