...
%
% Status: 99.99% jeśli bibliografia będzie wyrzucana to muszę ją usunąć z swojej części; nie do końca wiem co napisać o podłączeniu czujników
% --------------------------------------------------------
...
% Status: 80%
% --------------------------------------------------------
Pierwszym problemem było zamontowanie samych silników, okazało się że otwory na mocowanie silników znajdowały się w innych miejscach niż było to potrzebne. W związku z tym, konieczne było wporpwadzenie listwy aluminiowej, która pozwoliła na stabilne przymocowanie silników do dolnej części pojazdu.

Kolejnym wyzwaniem było mocowanie kół do silników. Początkowo użyto długich śrub, jednak okazało się, że koła są zbyt niestabilne. Aby wyeliminować luzy, wprowadzono boczne listwy aluminiowe, przez które przechodza długie gwintowane szprychy. To rozwiązanie znaczenie poprawiło stabilnośc kół i zminimalizowało luzy, zapewniając lepsze diałanie całogo układu.
